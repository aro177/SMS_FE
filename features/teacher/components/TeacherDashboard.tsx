  ...
  return (
    <main className="min-h-dvh bg-[radial-gradient(circle_at_top_left,#fff8ef_0,#fbefe5_34%,#f6e7dc_100%)] p-4 text-[#2d211b] md:p-6">
      <div className="mx-auto grid max-w-[1500px] gap-4">
        <header className="rounded-3xl border border-[#ead8ca] bg-white/88 p-5 shadow-[0_18px_50px_rgba(123,82,52,0.10)]">
        ...
        <section className="grid min-h-[calc(100dvh-170px)] gap-4 xl:grid-cols-[420px_minmax(0,1fr)]">
          <aside className="min-h-0 overflow-y-auto rounded-3xl border border-[#ead8ca] bg-white/88 p-4 shadow-[0_18px_50px_rgba(123,82,52,0.10)]">
          ...
          <form className="min-h-0 overflow-hidden rounded-3xl border border-[#ead8ca] bg-white/88 shadow-[0_18px_50px_rgba(123,82,52,0.10)]" onSubmit={submitAttendance}>
            ...
            <div className="max-h-[calc(100dvh-305px)] overflow-y-auto">
            ...
            <div className="border-t border-[#ead8ca] bg-white px-5 py-4">
              <button
